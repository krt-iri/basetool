...
| [SPEZIALKOMMANDO_PLAN.md](SPEZIALKOMMANDO_PLAN.md) | The Spezialkommando-as-second-tenant-kind extension on top of the multi-Squadron baseline (V94+). |
