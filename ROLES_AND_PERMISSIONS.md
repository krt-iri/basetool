...
| **Audit-Logs** (Bank/Lager/Aufträge/Raffinerie/Mein Inventar) lesen + Zeitraum-PDF/JSON + Aufbewahrungs-Bereinigung (`/admin/audit-log`, `/api/v1/audit/**`, URL- **und** Methoden-Gate `hasRole('ADMIN')`) |   ❌    |   ❌    |  ❌   | ❌  |    ❌    |   ✅   |
