...
### R9 — V122 destructive cleanup *(separate track — see [`SC_WIKI_SYNC_DESTRUCTIVE_ROADMAP.md`](SC_WIKI_SYNC_DESTRUCTIVE_ROADMAP.md))*
...
- V-number drift: V115 / V116 went to R7 (`game_item_price`) / R8 (`is_manual_entry` backfill), and V117–V121 were claimed by features merged to `main` while this PR was open, so the destructive drop is **V122** (the draft §7 table called it V116).
