...
public class CacheConfig {
    ...
    public CacheManager cacheManager() {
        ...
        manager.setCacheNames(List.of(
                JOB_TYPES_CACHE, SQUADRONS_CACHE, LOCATIONS_CACHE,
                MANUFACTURERS_CACHE, MATERIALS_CACHE, MISSION_LEAD_TYPES_CACHE,
                REFINING_METHODS_CACHE, ROLES_CACHE, SHIP_TYPES_CACHE, STAR_SYSTEMS_CACHE
        ));
        return manager;
    }
}
