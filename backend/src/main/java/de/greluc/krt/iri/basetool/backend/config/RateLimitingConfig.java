...
public class RateLimitingConfig {
    ...
    @Bean
    public RateLimitingFilter rateLimitingFilter(RateLimitProperties properties, AppProblemProperties problemProperties) {
        return new RateLimitingFilter(properties, problemProperties);
    }

    @Bean
    public org.springframework.boot.web.servlet.FilterRegistrationBean<jakarta.servlet.Filter> rateLimitingFilterRegistration(RateLimitingFilter filter) {
