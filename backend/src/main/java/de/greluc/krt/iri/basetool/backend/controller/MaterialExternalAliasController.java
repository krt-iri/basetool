...
import de.greluc.krt.iri.basetool.backend.mapper.MaterialExternalAliasMapper;
 ...
 * UEX or SC Wiki) onto local {@link de.greluc.krt.iri.basetool.backend.model.Material} rows.
 *
