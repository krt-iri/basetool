...
public class MissionController {
    ...
    @PutMapping("/{id}")
    @PreAuthorize("@missionSecurityService.canManageMission(#id, authentication)")
    @Operation(summary = "Update a mission (full replace)",
            description = "Aktualisiert den gesamten Einsatz in einem Request. Fuer eine bessere "
    ...
    @PreAuthorize("@missionSecurityService.canManageMission(#id, authentication)")
    @Operation(summary = "Patch mission core section",
            description = "Aktualisiert nur die Stammdaten-Sektion (Name, Beschreibung, Kalenderlink, "
    ...
    public MissionDto patchMissionCore(@PathVariable @NotNull UUID id,
        ...
        return missionMapper.toDto(missionService.updateCoreSection(id, request.name(), request.description(),
                request.calendarLink(), request.status(), request.version()));
    }

    @PatchMapping("/{id}/schedule")
    @PreAuthorize("@missionSecurityService.canManageMission(#id, authentication)")
    @Operation(summary = "Patch mission schedule section",
            description = "Aktualisiert nur die Zeitplan-Sektion (Meeting-/Planned-/Actual-Zeiten) eines "
    ...
    public MissionDto patchMissionSchedule(@PathVariable @NotNull UUID id,
                                           @RequestBody @jakarta.validation.Valid @NotNull
                                           de.greluc.krt.iri.basetool.backend.model.dto.request.PatchMissionScheduleRequest request) {
        return missionMapper.toDto(missionService.updateScheduleSection(id,
                request.meetingTime(), request.plannedStartTime(), request.plannedEndTime(),
                request.actualStartTime(), request.actualEndTime(), request.version()));
    }

    @PatchMapping("/{id}/flags")
    @PreAuthorize("@missionSecurityService.canManageMission(#id, authentication)")
    @Operation(summary = "Patch mission flags section",
            description = "Aktualisiert nur die Flags-Sektion (z.B. isInternal) eines Einsatzes.")
    public MissionDto patchMissionFlags(@PathVariable @NotNull UUID id,
                                        @RequestBody @jakarta.validation.Valid @NotNull
                                        de.greluc.krt.iri.basetool.backend.model.dto.request.PatchMissionFlagsRequest request) {
        return missionMapper.toDto(missionService.updateFlagsSection(id, request.isInternal(), request.version()));
    }
    ...
    @Operation(summary = "Add a unit to a mission (legacy, deprecated)",
            description = "Returns the full MissionDto. Prefer POST /api/v1/missions/{id}/units/slim which returns only the updated list of units and avoids parent-coupled payloads (Option A / multi-user concurrency).",
            deprecated = true)
    ...
    @Operation(summary = "Update a mission unit (legacy, deprecated)",
            description = "Returns the full MissionDto. Prefer PUT /api/v1/missions/{id}/units/{unitId}/slim which returns only the updated unit.",
            deprecated = true)
    ...
    @de.greluc.krt.iri.basetool.backend.annotation.ApiDeprecation(
            sunset = SLIM_DEPRECATION_SUNSET,
            replacement = "/api/v1/missions/{id}/units/{unitId}/slim")
    @Operation(summary = "Delete a mission unit (legacy, deprecated)",
            description = "Returns the full MissionDto. Prefer DELETE /api/v1/missions/{id}/units/{unitId}/slim which returns 204 No Content.",
            deprecated = true)
    ...
    @Operation(summary = "Add crew to a mission unit (legacy, deprecated)",
            description = "Returns the full MissionDto. Prefer POST /api/v1/missions/{id}/units/{missionUnitId}/crew/slim which returns only the crew list of the affected unit.",
            deprecated = true)
    ...
    @Operation(summary = "Update crew in a mission unit (legacy, deprecated)",
            description = "Returns the full MissionDto. Prefer PUT /api/v1/missions/{id}/units/{missionUnitId}/crew/{crewId}/slim which returns only the updated crew entry.",
            deprecated = true)
    ...
    @de.greluc.krt.iri.basetool.backend.annotation.ApiDeprecation(
            sunset = SLIM_DEPRECATION_SUNSET,
            replacement = "/api/v1/missions/{id}/units/{missionUnitId}/crew/{crewId}/slim")
    @Operation(summary = "Remove crew from a mission unit (legacy, deprecated)",
            description = "Returns the full MissionDto. Prefer DELETE /api/v1/missions/{id}/units/{missionUnitId}/crew/{crewId}/slim which returns 204 No Content.",
            deprecated = true)
    ...
    @Operation(summary = "Update a participant (legacy, deprecated)",
            description = "Returns the full MissionDto. Prefer PUT /api/v1/missions/{id}/participants/{participantId}/slim which returns only the updated participant.",
            deprecated = true)
    ...
    @Operation(summary = "Check in a participant (legacy, deprecated)",
            description = "Returns the full MissionDto. Prefer POST /api/v1/missions/{id}/participants/{participantId}/check-in/slim which returns only the updated participant.",
            deprecated = true)
    ...
    @Operation(summary = "Check out a participant (legacy, deprecated)",
            description = "Returns the full MissionDto. Prefer POST /api/v1/missions/{id}/participants/{participantId}/check-out/slim which returns only the updated participant.",
            deprecated = true)
    ...
    @Operation(summary = "Update payout preference for a participant (legacy, deprecated)",
            description = "Returns the full MissionDto. Prefer PUT /api/v1/missions/{id}/participants/{participantId}/payout-preference/slim which returns only the updated participant.",
            deprecated = true)
    ...
    @Operation(summary = "Add a participant (admin, legacy, deprecated)",
            description = "Returns the full MissionDto. Prefer POST /api/v1/missions/{id}/participants/slim which returns only the updated participant list.",
            deprecated = true)
    ...
    @de.greluc.krt.iri.basetool.backend.annotation.ApiDeprecation(
            sunset = SLIM_DEPRECATION_SUNSET,
            replacement = "/api/v1/missions/{id}/participants/{participantId}/slim")
    @Operation(summary = "Remove a participant (legacy, deprecated)",
            description = "Returns the full MissionDto. Prefer DELETE /api/v1/missions/{id}/participants/{participantId}/slim which returns 204 No Content.",
            deprecated = true)
    ...
    @Operation(summary = "Add or update a frequency for a mission (legacy, deprecated)",
            description = "Returns the full MissionDto. Prefer POST /api/v1/missions/{id}/frequencies/slim which returns only the updated frequency list.",
            deprecated = true)
    ...
    @Operation(summary = "Remove a frequency from a mission (legacy, deprecated)",
            description = "Returns the full MissionDto. Prefer DELETE /api/v1/missions/{id}/frequencies/{frequencyId}/slim which returns 204 No Content.",
            deprecated = true)
    ...
    @Operation(summary = "Add a manager to a mission (legacy, deprecated)",
            description = "Returns the full MissionDto. Prefer POST /api/v1/missions/{id}/managers/{userId}/slim which returns only the updated manager list.",
            deprecated = true)
    ...
    @de.greluc.krt.iri.basetool.backend.annotation.ApiDeprecation(
            sunset = SLIM_DEPRECATION_SUNSET,
            replacement = "/api/v1/missions/{id}/managers/{userId}/slim")
    @Operation(summary = "Remove a manager from a mission (legacy, deprecated)",
            description = "Returns the full MissionDto. Prefer DELETE /api/v1/missions/{id}/managers/{userId}/slim which returns 204 No Content.",
            deprecated = true)
    ...
    @Operation(
            ...
            description = "Legacy endpoint without optimistic lock on the ownership aggregate. "
            ...
            deprecated = true)
    public MissionDto setMissionOwnerLegacy(@PathVariable @NotNull UUID id, @PathVariable @NotNull UUID userId) {
        log.info("[DEBUG_LOG] MissionController.setMissionOwnerLegacy START - id: {}, userId: {}", id, userId);
        try {
            var mission = missionService.setMissionOwner(id, userId);
            log.info("[DEBUG_LOG] MissionController.setMissionOwnerLegacy SUCCESS - id: {}, userId: {}", id, userId);
            return missionMapper.toDto(mission);
        } catch (Exception e) {
            log.error("[DEBUG_LOG] MissionController.setMissionOwnerLegacy ERROR - id: {}, userId: {}, error: {}", id, userId, e.getMessage(), e);
            throw e;
        }
    }
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Owner updated"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "Validation error"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "403", description = "Forbidden"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "Mission or user not found"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "409", description = "Ownership version conflict (application/problem+json)")
    })
    ...
    @PreAuthorize("@missionSecurityService.canManageMission(#id, authentication)")
    @Operation(summary = "Add a unit to a mission (slim response)",
            description = "Adds a new unit and returns the updated list of units as slim DTOs. "
                    + "Preferred replacement for POST /api/v1/missions/{id}/units to support "
                    + "multi-user concurrency on the mission detail page.")
    public List<MissionUnitDto> addUnitSlim(@PathVariable @NotNull UUID id,
                                            @jakarta.validation.Valid @RequestBody @NotNull AddUnitRequest request) {
        var mission = missionService.addUnitToMission(id, request.name(), request.shipTypeId(),
                request.shipId(), request.isHighValueUnit(), request.frequency());
        return mission.getAssignedUnits().stream().map(missionMapper::toDto).toList();
    }

    @PutMapping("/{id}/units/{unitId}/slim")
    @PreAuthorize("@missionSecurityService.canManageMission(#id, authentication)")
    @Operation(summary = "Update a mission unit (slim response)",
            description = "Updates a unit and returns only the updated unit as a slim DTO.")
    public MissionUnitDto updateUnitSlim(@PathVariable @NotNull UUID id,
                                         @PathVariable @NotNull UUID unitId,
                                         @jakarta.validation.Valid @RequestBody @NotNull AddUnitRequest request) {
        var mission = missionService.updateMissionUnit(id, unitId, request.name(), request.shipTypeId(),
                request.shipId(), request.isHighValueUnit(), request.frequency());
    ...
    @PreAuthorize("@missionSecurityService.canManageMission(#id, authentication)")
    @Operation(summary = "Delete a mission unit (slim response)",
            description = "Deletes a unit and returns 204 No Content.")
    public ResponseEntity<Void> deleteUnitSlim(@PathVariable @NotNull UUID id,
                                               @PathVariable @NotNull UUID unitId) {
    ...
    @PreAuthorize("@missionSecurityService.canManageMission(#id, authentication)")
    @Operation(summary = "Add crew to a mission unit (slim response)",
            description = "Adds a crew member and returns the updated crew list of the affected unit as slim DTOs.")
    public List<MissionCrewDto> addCrewSlim(@PathVariable @NotNull UUID id,
                                            @PathVariable @NotNull UUID missionUnitId,
                                            @RequestBody @jakarta.validation.Valid @NotNull AddCrewRequest request) {
        java.util.Set<UUID> jobTypeIds = request.jobTypeIds() != null ? request.jobTypeIds() : java.util.Collections.emptySet();
        var mission = missionService.addCrewToShip(id, missionUnitId, request.participantId(), jobTypeIds);
        return missionMapper.toDto(findUnit(mission, missionUnitId)).crew();
    }

    @PutMapping("/{id}/units/{missionUnitId}/crew/{crewId}/slim")
    @PreAuthorize("@missionSecurityService.canManageMission(#id, authentication)")
    @Operation(summary = "Update crew in a mission unit (slim response)",
            description = "Updates a crew member and returns only the updated crew entry as a slim DTO.")
    public MissionCrewDto updateCrewSlim(@PathVariable @NotNull UUID id,
                                         @PathVariable @NotNull UUID missionUnitId,
    ...
    @PreAuthorize("@missionSecurityService.canManageMission(#id, authentication)")
    @Operation(summary = "Remove crew from a mission unit (slim response)",
            description = "Removes a crew member and returns 204 No Content.")
    public ResponseEntity<Void> removeCrewSlim(@PathVariable @NotNull UUID id,
                                               @PathVariable @NotNull UUID missionUnitId,
                                               @PathVariable @NotNull UUID crewId) {
    ...
    @PreAuthorize("@missionSecurityService.canAccessParticipant(#id, #participantId, authentication)")
    @Operation(summary = "Update a participant (slim response)",
            description = "Updates a participant and returns only the updated participant as a slim DTO.")
    public MissionParticipantDto updateParticipantSlim(@PathVariable @NotNull UUID id,
        ...
        var mission = missionService.updateParticipantAttributes(id, participantId,
                request.desiredMissionJobTypeId(),
                request.plannedMissionJobTypeId(),
                request.comment(),
                request.startTime(),
    ...
    @PreAuthorize("@missionSecurityService.canAccessParticipant(#id, #participantId, authentication)")
    @Operation(summary = "Check in a participant (slim response)",
            description = "Checks in a participant and returns only the updated participant as a slim DTO.")
    public MissionParticipantDto checkInParticipantSlim(@PathVariable @NotNull UUID id,
                                                        @PathVariable @NotNull UUID participantId,
                                                        Authentication authentication) {
    ...
    @PreAuthorize("@missionSecurityService.canAccessParticipant(#id, #participantId, authentication)")
    @Operation(summary = "Check out a participant (slim response)",
            description = "Checks out a participant and returns only the updated participant as a slim DTO.")
    public MissionParticipantDto checkOutParticipantSlim(@PathVariable @NotNull UUID id,
                                                         @PathVariable @NotNull UUID participantId,
                                                         Authentication authentication) {
    ...
    @PreAuthorize("@missionSecurityService.canAccessParticipant(#id, #participantId, authentication)")
    @Operation(summary = "Update payout preference for a participant (slim response)",
            description = "Updates the payout preference and returns only the updated participant as a slim DTO.")
    public MissionParticipantDto updatePayoutPreferenceSlim(@PathVariable @NotNull UUID id,
                                                            @PathVariable @NotNull UUID participantId,
    ...
    @PreAuthorize("@missionSecurityService.canAccessParticipant(#id, #participantId, authentication)")
    @Operation(summary = "Remove a participant (slim response)",
            description = "Removes a participant and returns 204 No Content.")
    public ResponseEntity<Void> removeParticipantSlim(@PathVariable @NotNull UUID id,
                                                      @PathVariable @NotNull UUID participantId,
                                                      Authentication authentication) {
    ...
    @PreAuthorize("@missionSecurityService.canManageMission(#id, authentication)")
    @Operation(summary = "Add or update a frequency for a mission (slim response)",
            description = "Adds or updates a frequency and returns the updated frequency list as slim DTOs.")
    public List<MissionFrequencyDto> addOrUpdateFrequencySlim(@PathVariable @NotNull UUID id,
                                                              @RequestBody @jakarta.validation.Valid de.greluc.krt.iri.basetool.backend.model.dto.request.AddFrequencyRequest request) {
        var mission = missionService.addOrUpdateMissionFrequency(id, request.frequencyTypeId(), request.value());
        return mission.getFrequencies().stream().map(missionMapper::toDto).toList();
    }

    @DeleteMapping("/{id}/frequencies/{frequencyId}/slim")
    @PreAuthorize("@missionSecurityService.canManageMission(#id, authentication)")
    @Operation(summary = "Remove a frequency from a mission (slim response)",
            description = "Removes a frequency and returns 204 No Content.")
    public ResponseEntity<Void> removeFrequencySlim(@PathVariable @NotNull UUID id,
    ...
    @PreAuthorize("@missionSecurityService.canManageManagers(#id, authentication)")
    @Operation(summary = "Add a manager to a mission (slim response)",
            description = "Adds a manager and returns the updated manager list as UserReferenceDto.")
    public List<UserReferenceDto> addManagerSlim(@PathVariable @NotNull UUID id,
    ...
    @PreAuthorize("@missionSecurityService.canManageManagers(#id, authentication)")
    @Operation(summary = "Remove a manager from a mission (slim response)",
            description = "Removes a manager and returns 204 No Content.")
    public ResponseEntity<Void> removeManagerSlim(@PathVariable @NotNull UUID id,
                                                  @PathVariable @NotNull UUID userId) {
