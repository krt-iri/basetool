  ...
  @Operation(
      ...
      description =
          "For each participant across all missions of the operation, returns the time-share "
              ...
              + "(totalSum × percentage / 100, 0 for DONATE), the flat 0.5% in-game banking "
              + "transfer fee deducted from the gross payout (`transferFee`) and the resulting "
              + "net payout amount (`payoutAmount = personalExpenses + shareAmount − "
