...
public class PromotionCategoryController {
   ...
   * given parent {@link de.greluc.krt.iri.basetool.backend.model.PromotionTopic}.
   *
  ...
  /**
   * Persists a new {@link de.greluc.krt.iri.basetool.backend.model.PromotionCategory} attached to
   * the topic referenced by the request. Restricted to ADMIN or OFFICER callers.
   *
  ...
  /**
   * Updates the {@link de.greluc.krt.iri.basetool.backend.model.PromotionCategory} identified by
