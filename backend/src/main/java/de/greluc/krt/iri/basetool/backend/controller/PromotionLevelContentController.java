...
public class PromotionLevelContentController {
  ...
  /**
   * Persists a new {@link de.greluc.krt.iri.basetool.backend.model.PromotionLevelContent}, binding
   * the expectations of a single rank level to the referenced category. Restricted to ADMIN or
   * OFFICER callers.
   *
  ...
  public PromotionLevelContentResponse create(
      @Valid @RequestBody PromotionLevelContentCreateRequest request) {
  ...
  public PromotionLevelContentResponse update(
      @PathVariable UUID id, @Valid @RequestBody PromotionLevelContentUpdateRequest request) {
