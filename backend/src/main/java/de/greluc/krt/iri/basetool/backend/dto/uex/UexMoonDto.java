...
/**
 * Inbound JSON record for UEX Corp's <code>/moons</code> endpoint. Mapped to the project's own
 * {@code Moon} entity by {@code UexUniverseSyncService}; downstream code consumes the entity, not
 * this DTO.
 */
@Builder
public record UexMoonDto(
  ...
  /** Returns {@code true} iff UEX reports the moon as currently reachable in-game. */
