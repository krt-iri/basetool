 ...
 * to an existing row. Handled centrally by
 * {@link de.greluc.krt.iri.basetool.backend.exception.GlobalExceptionHandler} and mapped to an
 * HTTP {@code 404 Not Found} RFC7807 problem response.
 *
 ...
 * externally crawled / deleted mission IDs). 404 is the semantically correct status and keeps
 * the logs clean.
 */
