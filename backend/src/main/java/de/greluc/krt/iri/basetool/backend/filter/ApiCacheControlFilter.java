...
/**
 * Adds conservative Cache-Control headers for idempotent API GET responses to enable client-side revalidation
 * via ETag while avoiding stale caches for dynamic data.
 */
@Component
