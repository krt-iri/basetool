...
/**
 * Write DTO for updating an existing personal inventory entry. The {@code version} field
 * is mandatory: it carries the entity's last-seen optimistic-locking version, so concurrent
