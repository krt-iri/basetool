...
public interface LocationRepository extends JpaRepository<Location, UUID> {
    ...
    @Query("SELECT new de.greluc.krt.iri.basetool.backend.model.dto.LocationReferenceDto(l.id, l.name) FROM Location l WHERE l.hidden = false ORDER BY l.name")
    ...
    @Query("SELECT l FROM Location l LEFT JOIN l.city c LEFT JOIN l.spaceStation s WHERE c.hasRefinery = true OR s.hasRefinery = true")
