...
public interface UserRepository extends JpaRepository<User, UUID> {
    ...
    @Query("SELECT new de.greluc.krt.iri.basetool.backend.model.dto.UserReferenceDto(u.id, u.username, u.displayName, CASE WHEN (u.displayName IS NOT NULL AND u.displayName <> '') THEN u.displayName ELSE u.username END, u.rank) FROM User u ORDER BY u.displayName")
