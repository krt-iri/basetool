 ...
 * de.greluc.krt.iri.basetool.backend.model.dto.PersonalBlueprintResponse} as non-removable so the
 * UI hides its delete control and (b) guard the delete endpoint server-side.
 *
