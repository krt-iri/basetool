...
public class PersonalBlueprintController {
  ...
  public PersonalBlueprintBulkDeleteResult deleteAll(JwtAuthenticationToken auth) {
    return new PersonalBlueprintBulkDeleteResult(service.deleteAllOwn(requireSub(auth)));
  }
