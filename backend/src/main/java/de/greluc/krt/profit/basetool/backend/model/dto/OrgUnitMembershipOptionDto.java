 ...
 * de.greluc.krt.profit.basetool.backend.model.Squadron} or a {@link
 * de.greluc.krt.profit.basetool.backend.model.SpecialCommand} row — both live in the shared {@code
