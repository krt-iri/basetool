-- =====================================================================
-- V94 - Spezialkommando R1 step 1: create org_unit and copy squadron rows
-- =====================================================================
...
-- eventually reference `org_unit.id` via renamed FK columns - V96 adds
...
-- R2 stop-write lands. After V94 both tables exist with identical
...
-- org_unit_membership (V95) and several upcoming filter queries narrow
...
-- after V100 (legacy squadron dropped) must remain a no-op even when
