-- =====================================================================
-- V99 - Spezialkommando R1 step 3: aggregate FK columns + indexes
-- =====================================================================
...
-- (dual-write window); R3's V101-V105 will tighten NOT NULL on the new
-- columns and drop the legacy ones once prod confirms persistence.
--
-- Backfill is straightforward because V97 copied every squadron row
