...
class ArchitectureTest {
   ...
   * de.greluc.krt.iri.basetool.backend.model.OrgUnit}. The V95 CHECK constraint blocks the
   ...
   * de.greluc.krt.iri.basetool.backend.model.SpecialCommand} reference, bypass the V95
