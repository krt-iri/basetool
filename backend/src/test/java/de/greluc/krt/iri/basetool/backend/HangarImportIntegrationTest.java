...
class HangarImportIntegrationTest {
    ...
    void importFleetview_success_importsMatchedShips() throws Exception {
        ...
        String json = """
                ...
                """;
        MockMultipartFile file = new MockMultipartFile("file", "fleetview.json",
                "application/json", json.getBytes(StandardCharsets.UTF_8));

        // When
        String response = mockMvc.perform(multipart("/api/v1/hangar/import/fleetview")
                .file(file)
        ...
        // Then
        FleetviewImportResponseDto result = objectMapper.readValue(response, FleetviewImportResponseDto.class);
    ...
    void importFleetview_unauthenticated_returns401() throws Exception {
        ...
        // When / Then
        mockMvc.perform(multipart("/api/v1/hangar/import/fleetview")
                .file(file))
