...
class JobTypeCachingTest {
    ...
    void cacheShouldHit_OnSecondCall_WithSameParams() {
        ...
        org.junit.jupiter.api.Assertions.assertNotNull(cached, "Expected cache to contain entry after first call");
    }
    ...
    void cacheShouldEvict_OnCreate() {
        ...
        org.junit.jupiter.api.Assertions.assertNull(cachedAfterEvict, "Expected cache to be evicted after create operation");
        ...
        org.junit.jupiter.api.Assertions.assertNotNull(cachedAfterRepopulate, "Expected cache to be repopulated after subsequent call");
    }
}
