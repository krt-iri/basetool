...
class MissionAccessControlTest {
    ...
    void testUpdateParticipant_Self_Allowed() throws Exception {
        ...
        String updateJson = "{\"desiredMissionJobTypeId\": \"" + testJobType.getId() + "\", \"comment\": \"Ready\"}";
    ...
    void testUpdateParticipant_OtherGuest_Forbidden() throws Exception {
        ...
        String updateJson = "{\"desiredMissionJobTypeId\": \"" + testJobType.getId() + "\", \"comment\": \"Malicious\"}";
    ...
    void testUpdateParticipant_Officer_Allowed() throws Exception {
        ...
        String updateJson = "{\"desiredMissionJobTypeId\": \"" + testJobType.getId() + "\", \"comment\": \"Approved\"}";
    ...
    void testUpdateParticipant_AllFields() throws Exception {
        ...
        String updateJson = String.format(
            "{\"desiredMissionJobTypeId\": \"%s\", \"plannedMissionJobTypeId\": \"%s\", \"comment\": \"Full Update\"}",
    ...
    void testSearchMissions_Guest_Default_ShouldSeeOnlyPlannedAndActive() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/missions/search"))
                ...
                .andExpect(jsonPath("$.content[?(@.status == 'PLANNED')]").exists())
                .andExpect(jsonPath("$.content[?(@.status == 'ACTIVE')]").exists());
    }
    ...
    void testSearchMissions_Guest_ExplicitPast_ShouldBeIgnored() throws Exception {
        ...
        // Guest requests completed/cancelled explicitly -> Should receive empty list now (filtered out)
        mockMvc.perform(get("/api/v1/missions/search")
    ...
    void testAddParticipantPublic_Anonymous_Allowed() throws Exception {
        ...
        String jsonBody = "{\"guestName\": \"John Doe\", \"comment\": \"I want to join\"}";
