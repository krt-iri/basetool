...
class MissionExpansionTest {
    ...
    void testMissionExpansion() {
        ...
        mission = missionService.addUnitToMission(mission.getId(), "Expansion Unit", fighter.getId(), ship.getId(), false, null);
        ...
        mission = missionService.addCrewToShip(mission.getId(), missionShip.getId(), participant.getId(), jobTypeIds);
