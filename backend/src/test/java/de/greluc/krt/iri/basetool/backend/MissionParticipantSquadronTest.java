...
class MissionParticipantSquadronTest {
    ...
    void addParticipant_Guest_WithSquadronId_ShouldAssignSquadron() {
        // Act
        Mission updatedMission = missionService.addParticipant(mission.getId(), null, "Guest", null, "Comment", testSquadron.getId());
    ...
    void addParticipant_Guest_WithInvalidSquadronId_ShouldAssignNull() {
        // Act
        Mission updatedMission = missionService.addParticipant(mission.getId(), null, "Guest2", null, "Comment", UUID.randomUUID());
