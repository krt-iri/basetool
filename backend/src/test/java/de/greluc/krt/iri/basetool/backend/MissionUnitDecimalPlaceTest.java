...
class MissionUnitDecimalPlaceTest {
    ...
    void testAddUnitWithThreeDecimalPlaces_ShouldRoundUp() throws Exception {
        ...
        String requestJson = "{\"name\": \"Test Unit\", \"shipTypeId\": \"" + shipType.getId() + "\", \"shipId\": \"" + ship.getId() + "\", \"frequency\": 100.126}";
    ...
    void testAddUnitWithThreeDecimalPlaces_ShouldRoundDown() throws Exception {
        ...
        String requestJson = "{\"name\": \"Test Unit\", \"shipTypeId\": \"" + shipType.getId() + "\", \"shipId\": \"" + ship.getId() + "\", \"frequency\": 100.123}";
