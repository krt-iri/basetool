...
class UserJoinDateTest {
    ...
    void shouldSetJoinDate_WhenAdminUpdatesAttributes() throws Exception {
        ...
        String updateJson = "{\"rank\": 5, \"version\": " + testUser.getVersion() + ", \"joinDate\": \"" + joinDate + "\"}";
    ...
    void shouldSetJoinDate_WhenOfficerUpdatesAttributes() throws Exception {
        ...
        String updateJson = "{\"rank\": 3, \"version\": " + testUser.getVersion() + ", \"joinDate\": \"" + joinDate + "\"}";
    ...
    void shouldClearJoinDate_WhenNullIsSent() throws Exception {
        ...
        String updateJson = "{\"rank\": 1, \"version\": " + testUser.getVersion() + ", \"joinDate\": null}";
    ...
    void shouldForbidJoinDateUpdate_WhenMemberRole() throws Exception {
        // Given
        String updateJson = "{\"rank\": 1, \"version\": " + testUser.getVersion() + ", \"joinDate\": \"2024-01-01\"}";
