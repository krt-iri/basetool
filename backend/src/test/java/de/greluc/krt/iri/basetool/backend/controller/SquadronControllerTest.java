...
/**
 * Pure-method unit tests for {@link SquadronController}. The Spring-MVC
 * binding (`@PreAuthorize`, JSON) is covered by integration tests; here we
 * verify the controller's delegation contract and pagination wrapping.
 */
