...
class DeprecationInterceptorTest {
    ...
    @Test
    void preHandle_withApiDeprecationWithoutSunsetOrReplacement_shouldOnlyAddDeprecation() throws Exception {
        // Given
    ...
    private static HandlerMethod handlerMethodOf(Class<?> beanClass, String methodName) throws Exception {
    ...
    static class SampleController {
        ...
        public String clean() { return "ok"; }

        @Deprecated
        public String javaDeprecatedOnly() { return "ok"; }

        @ApiDeprecation(sunset = "2027-01-01", replacement = "/api/v2/things")
        public String fullyDeprecated() { return "ok"; }

        @ApiDeprecation
        public String minimalApiDeprecation() { return "ok"; }

        @ApiDeprecation(sunset = "not-a-date", replacement = "/api/v2/foo")
        public String badSunsetDate() { return "ok"; }
    }
