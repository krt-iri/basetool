...
class EntityMappersTest {
    ...
    void jobTypeToEntity_shouldRebuildShallowParent_whenParentIdProvided() {
        ...
        UUID jtId = UUID.randomUUID();
        JobTypeDto dto = new JobTypeDto(jtId, "Child", "desc",
                JobTypeArchetype.CREW, parentId, true, false, 1L);
    ...
    void jobTypeToEntity_withoutParentId_shouldHaveNullParent() {
        // Given
        JobTypeDto dto = new JobTypeDto(UUID.randomUUID(), "Solo", null,
                JobTypeArchetype.MISSION, null, true, true, 1L);
