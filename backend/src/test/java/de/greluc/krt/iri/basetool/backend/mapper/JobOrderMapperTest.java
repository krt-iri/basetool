...
class JobOrderMapperTest {
    ...
    void toDto_withHandovers_shouldMapEachHandoverViaHandoverMapper() {
        ...
        assertEquals(jobOrder.getId(), hDto.jobOrderId(), "jobOrderId must be flattened from nested handover.jobOrder.id");
    ...
    void mapAndSortMaterials_shouldSortScuFirstThenAlphabetically() {
        ...
        JobOrderMaterial jm1 = new JobOrderMaterial(); jm1.setId(UUID.randomUUID()); jm1.setMaterial(gold);   jm1.setMinQuality(0); jm1.setAmount(1.0);
        JobOrderMaterial jm2 = new JobOrderMaterial(); jm2.setId(UUID.randomUUID()); jm2.setMaterial(iron);   jm2.setMinQuality(0); jm2.setAmount(1.0);
        JobOrderMaterial jm3 = new JobOrderMaterial(); jm3.setId(UUID.randomUUID()); jm3.setMaterial(silver); jm3.setMinQuality(0); jm3.setAmount(1.0);
        JobOrderMaterial jm4 = new JobOrderMaterial(); jm4.setId(UUID.randomUUID()); jm4.setMaterial(copper); jm4.setMinQuality(0); jm4.setAmount(1.0);
    ...
    void mapAndSortMaterials_shouldHandleNullMaterialOnEntryGracefully() {
        ...
        // Then — Gold first (SCU group), broken entry falls into the PIECE / no-material group at the end
