...
class JobTypeMapperTest {
    ...
    void toEntity_shouldCreateShallowParent_whenParentIdProvided() {
        ...
        JobTypeDto dto = new JobTypeDto(UUID.randomUUID(), "Child", null, JobTypeArchetype.CREW, parentId, true, false, null);
    ...
    void toEntity_withNullParentId_shouldSetParentNull() {
        JobTypeDto dto = new JobTypeDto(UUID.randomUUID(), "Solo", null, JobTypeArchetype.CREW, null, true, false, null);
        JobType entity = mapper.toEntity(dto);
