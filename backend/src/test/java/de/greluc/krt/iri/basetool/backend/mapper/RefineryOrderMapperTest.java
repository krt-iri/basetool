...
class RefineryOrderMapperTest {
    ...
    void missionDtoToMission_shouldOnlyCopyId() {
        ...
        MissionDto dto = new MissionDto(
                missionId, "Op Sunfire", "desc", null, "PLANNED",
                null, null, null, null, null,           // 5 Instants + 1 status set above
                null, null, null, null, null, null, null, // isInternal, participants, units, frequencies, subMissions, inventoryEntries, refineryOrders
                null, null, null,                        // operation, owner, managers
                null, null,                              // canEdit, canManageManagers
                null,                                    // version
                null, null                               // checkedInParticipants, registeredParticipants
        );
