...
class UexCommodityServiceTest {
    ...
    void commoditySync_linksByName_whenIdCommodityIsNewButNameMatches() {
        ...
        assertEquals(5, cap.getValue().getIdCommodity(),
                "id_commodity must be backfilled from the UEX payload");
    }
    ...
    void commoditySync_swallowsExceptionPerRow_andContinuesBatch() {
        ...
        when(materialRepository.save(any())).thenThrow(new RuntimeException("DB hiccup")).thenReturn(new Material());
    ...
    void priceSync_updatesExistingPriceRow_inPlace() {
        ...
        UexCommodityPriceDto fresh = new UexCommodityPriceDto(
                1, "Gold", 42, "term",
                new BigDecimal("99.00"), new BigDecimal("111.00"),
                100, 50, 0, 0, 1, 1700000100L);
        ...
        assertEquals(2L, cap.getValue().getVersion(), "Version must remain — JPA owns optimistic locking");
    ...
    void priceSync_skipsRow_whenTerminalUnknown() {
        ...
        material.setIdCommodity(1);
        UexCommodityPriceDto orphan = new UexCommodityPriceDto(
                1, "X", 9999, "Unknown",
                BigDecimal.ONE, BigDecimal.ONE, 0, 0, 0, 0, 0, 1L);
    ...
    void priceSync_skipsRow_whenIdCommodityOrIdTerminalMissing() {
        UexCommodityPriceDto noCommodity = new UexCommodityPriceDto(
                null, "X", 1, "T", BigDecimal.ONE, BigDecimal.ONE, 0, 0, 0, 0, 0, 0L);
        UexCommodityPriceDto noTerminal = new UexCommodityPriceDto(
    ...
    void priceSync_createsPlaceholderMaterial_whenIdAndNameUnknown() {
        ...
        UexCommodityPriceDto payload = new UexCommodityPriceDto(
                123, "NewStuff", 7, "Terminal",
                BigDecimal.TEN, BigDecimal.TEN, 1, 1, 1, 1, 1, 1L);
        ...
        assertEquals(MaterialType.NO_REFINE, matCap.getValue().getType(),
    ...
    void priceSync_swallowsExceptionPerRow_andContinuesBatch() {
        UexCommodityPriceDto bad = new UexCommodityPriceDto(
                1, "A", 1, "T1", BigDecimal.ONE, BigDecimal.ONE, 0, 0, 0, 0, 0, 1L);
        UexCommodityPriceDto good = new UexCommodityPriceDto(
                2, "B", 2, "T2", BigDecimal.ONE, BigDecimal.ONE, 0, 0, 0, 0, 0, 1L);

        Material m1 = new Material(); m1.setId(UUID.randomUUID()); m1.setIdCommodity(1);
        Material m2 = new Material(); m2.setId(UUID.randomUUID()); m2.setIdCommodity(2);
        Terminal t1 = new Terminal(); t1.setId(UUID.randomUUID()); t1.setIdTerminal(1);
        Terminal t2 = new Terminal(); t2.setId(UUID.randomUUID()); t2.setIdTerminal(2);
        ...
        when(materialPriceRepository.findByMaterialIdAndTerminalId(any(), any())).thenReturn(Optional.empty());
    ...
    private static UexCommodityDto commodity(Integer id, String name, Integer isRefined, Integer isRefinable) {
        return new UexCommodityDto(
                id, name,
                /*code*/ "C", /*slug*/ "s", /*kind*/ "k", /*type*/ "t",
                /*weightScu*/ 1.0, /*priceBuy*/ 1.0, /*priceSell*/ 1.0,
                /*isAvailable*/ 1, /*isAvailableLive*/ 1, /*isExtractable*/ 0,
                /*isMineral*/ 0, /*isRaw*/ 0, /*isPure*/ 0,
                isRefinable, isRefined,
                /*isHarvestable*/ 0, /*isBuyable*/ 1, /*isSellable*/ 1, /*isTemporary*/ 0,
                /*isIllegal*/ 0, /*isVolatileQt*/ 0, /*isVolatileTime*/ 0,
                /*isInert*/ 0, /*isExplosive*/ 0, /*isBuggy*/ 0, /*isFuel*/ 0);
    }
}
