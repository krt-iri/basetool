...
class UserSyncTaskTest {
    ...
    void syncUsers_shouldFetchAndSyncUsers() {
        KeycloakUserDto user1 = new KeycloakUserDto(UUID.randomUUID(), "user1", "First", "Last", "u1@test.com", true, java.util.Collections.emptySet());
        KeycloakUserDto user2 = new KeycloakUserDto(UUID.randomUUID(), "user2", "First2", "Last2", "u2@test.com", true, java.util.Collections.emptySet());
