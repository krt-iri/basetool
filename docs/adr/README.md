...
| [0052](0052-standardize-user-selection-on-searchable-combobox.md)         | Standardize user-selection fields on the shared searchable combobox (username + display name; holder pickers by handle; guest fields carved out)          | Accepted                                          |
