...
| [UC-13](UC-13-job-order-bearbeiten.md)      | Job Order bearbeiten                | `e2e`   | `JobOrderEditE2eTest`         |
| [UC-14](UC-14-job-order-status.md)          | Job-Order-Status ändern             | `e2e`   | `JobOrderStatusE2eTest`       |
| [UC-15](UC-15-item-order-handover.md)       | Item-Auftrag & Item-Handover        | `e2e`   | `JobOrderItemHandoverE2eTest` |

UC-01 bis UC-07 sind als Playwright-Tests implementiert (Happy Path als Admin/IRIDIUM-Mitglied); UC-13 bis UC-15 erweitern die Job-Order-Flows um Bearbeiten, Status-Wechsel und Item-Auftrag/Item-Handover (ebenfalls `@Tag("e2e")`).
...
| [UC-16](UC-16-job-order-mandanten-sichtbarkeit.md) | Job Order: wer sieht was — SK-öffentliche Warteschlange vs. staffel-privat, Profit-Gate (REQ-ORG-003)                               | `JobOrderTenancyE2eTest`           |
