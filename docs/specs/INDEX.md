...
| Order-overview Materialien column                             | [`orders-overview-materials.md`](orders-overview-materials.md)                                                                  | Living             | Current                                                                                                                                                                                                                                 | ORDERS/UI          |
...
| Desktop one-click ingest (send-to-basetool)                   | [`desktop-ingest.md`](desktop-ingest.md)                                                                                        | Living             | Planned — implementation pending (epic #639)                                                                                                                                                                                            | INGEST             |
| Desktop ingest — Keycloak setup runbook                       | [`INGEST_KEYCLOAK_SETUP.md`](../INGEST_KEYCLOAK_SETUP.md)                                                                       | Runbook            | Open — operator deployment step (#641)                                                                                                                                                                                                  | INGEST             |
| Kartell bank — accounts, ledger, audit                        | [`bank.md`](bank.md)                                                                                                            | Living             | Implemented (epic #556); org-unit officer/lead view + booking requests (epic #666); holder ledger decoupled from accounts + holder Umbuchung + per-holder custody history + in-game transfer fee (ADR-0039/0040/0041, REQ-BANK-032/033) | BANK               |
| Activity audit logs (Lager/Aufträge/Raffinerie/Mein Inventar) | [`audit.md`](audit.md)                                                                                                          | Living             | Current — unified admin viewer + per-area PDF export                                                                                                                                                                                    | AUDIT              |
...
`ADMIN`, `UEX`, `UI`, `I18N`, `DB`, `OPS`, `NOTIF`, `INGEST`, `AUDIT`, `ROLE`. Numbers are never reused, even
