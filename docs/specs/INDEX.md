...
| Refinery screenshot import                | [`refinery-screenshot-import.md`](refinery-screenshot-import.md)                                                                | Living             | Current — alias hardening only    | REFINERY           |
| Refinery screenshot import (plan)         | [`REFINERY_SCREENSHOT_IMPORT_PLAN.md`](../REFINERY_SCREENSHOT_IMPORT_PLAN.md)                                                   | Forward plan       | Planned — epic #439, not started  | REFINERY           |
| SC Extractor GUI design                   | [`DESIGN_SC_EXTRACTOR.md`](../DESIGN_SC_EXTRACTOR.md)                                                                           | Forward plan       | Planned — binding design for #439 | REFINERY           |
