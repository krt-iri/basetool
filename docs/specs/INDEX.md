...
| Kartell bank — accounts, ledger, audit      | [`bank.md`](bank.md)                                                                                                            | Living             | Implemented (epic #556); org-unit officer/lead view + booking requests (epic #666) | BANK               |
...
| Discord integration — login, gate, approval | [`discord-integration.md`](discord-integration.md)                                                                              | Living             | Planned — implementation in progress (epic #720, Track 1)                          | AUTH/SEC           |
...
`ADMIN`, `UEX`, `UI`, `I18N`, `DB`, `OPS`, `NOTIF`, `INGEST`. Numbers are never reused, even
