...
public class AdminAnnouncementPageController {
    ...
    public String showAnnouncementPage(Model model) {
        try {
            Map<String, Object> adminAnnouncement = backendApiClient.get(
    ...
    @PostMapping("/update")
    public String updateAnnouncement(@RequestParam String content, @RequestParam(required = false) Long version, RedirectAttributes redirectAttributes) {
        try {
