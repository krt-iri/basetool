...
public class ShipDataPageController {
    ...
    public String listData(Model model) {
        ...
        try {
            PageResponse<ManufacturerDto> manufacturersPage = backendApiClient.get(
    ...
    public String toggleManufacturerVisibility(@PathVariable @NotNull UUID id, @RequestParam boolean hidden, RedirectAttributes redirectAttributes) {
        try {
            backendApiClient.put("/api/v1/manufacturers/" + id + "/visibility?hidden=" + hidden, null, Void.class);
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public String toggleShipTypeVisibility(@PathVariable @NotNull UUID id, @RequestParam boolean hidden, RedirectAttributes redirectAttributes) {
        try {
            backendApiClient.put("/api/v1/ship-types/" + id + "/visibility?hidden=" + hidden, null, Void.class);
            redirectAttributes.addFlashAttribute("successToast", "notification.success.save");
        } catch (Exception e) {
