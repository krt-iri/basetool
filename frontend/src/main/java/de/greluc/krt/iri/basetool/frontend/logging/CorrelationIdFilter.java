 ...
 * {@code sub} claim for JWT) is placed into the MDC for the duration of the request and removed
 * in the {@code finally} block to avoid thread-pool bleed-through.</p>
 *
 * <p>Intentionally limited to {@code sub} – never emails/names/tokens – to avoid PII in logs.</p>
 */
@Slf4j
@Component
