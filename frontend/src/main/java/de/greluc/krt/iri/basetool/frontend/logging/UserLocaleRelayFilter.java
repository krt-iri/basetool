 ...
 * de.greluc.krt.iri.basetool.frontend.config.ReactorContextPropagationConfig}) restores it on the
 * Reactor-Netty worker thread this filter executes on — the same mechanism the correlation-id and
 * active-OrgUnit relays rely on.
 *
