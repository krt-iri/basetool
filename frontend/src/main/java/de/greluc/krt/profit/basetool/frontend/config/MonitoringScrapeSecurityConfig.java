 ...
 * /actuator/prometheus} (REQ-OBS-005, ADR-0061, epic #936 Phase 1). Mirrors the backend/ingest
...
public class MonitoringScrapeSecurityConfig {
  ...
  public SecurityFilterChain monitoringScrapeFilterChain(HttpSecurity http) throws Exception {
    http.securityMatcher(PROMETHEUS_PATH)
        ...
        // protect, and a 30 s scrape interval must not accumulate Redis sessions or saved
        // requests.
