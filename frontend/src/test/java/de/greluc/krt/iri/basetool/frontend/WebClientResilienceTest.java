...
class WebClientResilienceTest {
    ...
    void circuitBreaker_ShouldOpenAndShortCircuit_SubsequentCalls() {
        ...
        try {
            ...
            assertTrue(e.getCause() instanceof CallNotPermittedException || e instanceof CallNotPermittedException,
    ...
    void timeLimiter_ShouldTimeoutSlowResponses() {
        ...
        try {
            publicWebClient.get().uri("/api/v1/slow").retrieve().bodyToMono(String.class)
                    .block();
