...
class AdminMissionDataPageControllerTest {
    ...
    void listData_ShouldSortListsAscendingByName() {
        ...
        AdminMissionDataPageController controller = new AdminMissionDataPageController(backendApiClient);
        ...
        PageResponse<Map<String, Object>> jobTypesPage = new PageResponse<>(jobTypes, 0, 1000, jobTypes.size(), 1, List.of("name,asc"));
        PageResponse<Map<String, Object>> squadronsPage = new PageResponse<>(squadrons, 0, 1000, squadrons.size(), 1, List.of("name,asc"));
