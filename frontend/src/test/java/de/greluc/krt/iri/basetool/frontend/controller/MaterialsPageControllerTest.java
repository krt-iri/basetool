...
class MaterialsPageControllerTest {
    ...
    void listMaterials_ShouldAddMaterialsToModel() {
        ...
        MaterialPriceOverviewDto dto = new MaterialPriceOverviewDto(
                UUID.randomUUID(),
                "Gold",
                new de.greluc.krt.iri.basetool.frontend.model.dto.MaterialCategoryDto(UUID.randomUUID(), "Mineral", 0L),
                false,
                false,
                false,
                new BigDecimal("5.0"),
        ...
        PageResponse<MaterialPriceOverviewDto> pageResponse = new PageResponse<>(
                List.of(dto),
                0,
                10000,
                1,
        ...
        List<MaterialPriceOverviewDto> materials = (List<MaterialPriceOverviewDto>) model.getAttribute("materials");
    ...
    void getMaterialDetail_ShouldAddMaterialAndPricesToModel() {
        ...
        MaterialDto materialDto = new MaterialDto(id, 1, "Gold", "Metal", "SCU", "Test description", null, null, false, false, false, false, false, 0L);
        ...
        PageResponse<MaterialPriceDto> pageResponse = new PageResponse<>(
                List.of(priceDto),
                0,
                1000,
                1,
