...
class OfficerRefineryButtonsTest {
    ...
    void refineryOrderDetail_AsOfficer_ShouldShowLogisticianButtons() throws Exception {
        ...
        RefineryOrderDto order = new RefineryOrderDto(
                orderId, null, null, null, java.time.Instant.now(), 60L, 100.0, 0d, 0d, 0d, null, java.util.Collections.emptyList(), de.greluc.krt.iri.basetool.frontend.model.dto.RefineryOrderStatus.OPEN, 1L
        );
