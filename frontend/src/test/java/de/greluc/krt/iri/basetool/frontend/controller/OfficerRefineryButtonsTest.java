...
class OfficerRefineryButtonsTest {
    ...
    void refineryOrderDetail_AsOfficer_ShouldShowLogisticianButtons() throws Exception {
        ...
        RefineryOrderDto order = new RefineryOrderDto(
                orderId, null, null, null, java.time.OffsetDateTime.now(), 60, 100, null, java.util.Collections.emptyList(), de.greluc.krt.iri.basetool.frontend.model.dto.RefineryOrderStatus.OPEN, 1L
        );
