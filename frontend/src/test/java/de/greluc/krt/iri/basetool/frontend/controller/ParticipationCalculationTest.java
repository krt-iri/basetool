...
class ParticipationCalculationTest {
    ...
    void testParticipationCalculation_KeyType() {
        ...
        MissionParticipantDto participant = new MissionParticipantDto(participantId, null, "P1", null, null, null, null, 
                missionStart, missionEnd, PayoutPreference.PAYOUT, 1L);
        ...
        // Assert
        Map<UUID, Double> percentages = (Map<UUID, Double>) model.getAttribute("participationPercentages");
        ...
        assertNull(percentages.get(participantId.toString()), "Map should NOT contain String keys anymore");
    }
    ...
    void testParticipationCalculation_MissingStartTime() {
        ...
        MissionParticipantDto p1 = new MissionParticipantDto(p1Id, null, "P1", null, null, null, null, 
                missionStart, missionStart.plusSeconds(3600), PayoutPreference.PAYOUT, 1L);
        
        // P2 has no startTime (not checked in yet)
        MissionParticipantDto p2 = new MissionParticipantDto(p2Id, null, "P2", null, null, null, null, 
                null, null, PayoutPreference.PAYOUT, 1L);
        ...
        assertTrue(percentages.containsKey(p2Id), "P2 should have a percentage entry even without startTime");
