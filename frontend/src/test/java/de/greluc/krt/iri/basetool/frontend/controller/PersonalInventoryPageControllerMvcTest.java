...
/**
 * MVC-level test for {@link PersonalInventoryPageController}: verifies that the user-area
 * personal inventory page renders for an authenticated user with model attributes filled
...
class PersonalInventoryPageControllerMvcTest {
    ...
    void view_shouldRenderPersonalInventoryView_whenAuthenticated() throws Exception {
        ...
        // When & Then
        mockMvc.perform(get("/personal-inventory"))
