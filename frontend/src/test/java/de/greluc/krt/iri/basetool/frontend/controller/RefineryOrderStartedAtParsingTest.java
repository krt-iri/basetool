...
/**
 * Regressionstest fuer den Bugfix der doppelten Sommerzeit-Umrechnung in
 * Raffinerieauftraegen. Der Parser MUSS ISO-Instants (UTC mit 'Z'), ISO-Offsets
 * und reine Datumseingaben deterministisch als UTC-Instant liefern und DARF
 * keine {@code ZoneId.systemDefault()}-Semantik verwenden.
 */
class RefineryOrderStartedAtParsingTest {
    ...
    void shouldBeIdempotentAcrossRoundTrip() {
        ...
        Instant original = OffsetDateTime.of(2026, 4, 19, 16, 30, 0, 0, ZoneOffset.ofHours(2)).toInstant();
