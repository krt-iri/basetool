...
class PiiMaskingPatternLayoutTest {
    ...
    void shouldMaskStandaloneJwt() {
        // Given
        ILoggingEvent event = createEvent("Received JWT eyJhbGciOiJIUzI1NiIsInR5cCI.eyJzdWIiOiIxMjM0NTY3ODkwIiwibmFtZ.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c");
    ...
    private ILoggingEvent createEvent(String message) {
        return new LoggingEvent("de.greluc.krt.iri.basetool.frontend.logging.PiiMaskingPatternLayoutTest", 
